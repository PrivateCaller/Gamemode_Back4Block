datablock AudioProfile(canOpen)
{
	filename = "./can_open.wav";
	description = audioClosest3D;
	preload = false;
};

datablock AudioProfile(canSpoon)
{
	filename = "./can_spoon.wav";
	description = audioClosest3D;
	preload = false;
};

datablock AudioProfile(gulp1)
{
	filename = "./gulp1.wav";
	description = audioClosest3D;
	preload = false;
};
datablock AudioProfile(gulp2)
{
	filename = "./gulp2.wav";
	description = audioClosest3D;
	preload = false;
};
datablock AudioProfile(gulp3)
{
	filename = "./gulp3.wav";
	description = audioClosest3D;
	preload = false;
...
function bakedbeansImage::onEat(%data, %obj, %slot)
{
	...
	%obj.playaudio(1, gulp @ getRandom(1,3));
