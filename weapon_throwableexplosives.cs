datablock ItemData(PropaneTankItem)
{
	...
	uiName = "Propane Tank";
	iconName = "add-ons/Package_Left4Block/icons/Icon_Propane";
	doColorShift = true;
...
datablock ItemData(GasCanItem)
{
	...
	//gui stuff
	uiName = "Gas Can";
	iconName = "add-ons/Package_Left4Block/icons/Icon_GasCan";
	doColorShift = true;
...
datablock ItemData(BileOGasItem)
{
	...
	iconName = "add-ons/Package_Left4Block/icons/Icon_BileOGas";
	doColorShift = false;
	colorShiftColor = "0.4 0.071 0.071 1.000";
...
datablock ItemData(OxygenTankItem)
{
	...
	//gui stuff
	uiName = "Oxygen Tank";
	iconName = "add-ons/Package_Left4Block/icons/Icon_OxygenTank";
	doColorShift = true;
	colorShiftColor = "0.4 0.071 0.071 1.000";
