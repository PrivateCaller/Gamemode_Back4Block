%pattern = "add-ons/gamemode_left4block/add-ins/player_l4b/sound/*.wav";
...
if(isFile("add-ons/gamemode_left4block/add-ins/player_l4b/models/decal.ifl"))
{
	%write = new FileObject();
	%write.openForWrite("add-ons/gamemode_left4block/add-ins/player_l4b/models/decal.ifl");		

	%decalpath = "add-ons/gamemode_left4block/add-ins/player_l4b/models/decals/*.png";
	...
	addExtraResource("add-ons/gamemode_left4block/add-ins/player_l4b/models/decal.ifl");
	%write.close();
	%write.delete();
}

addExtraResource("add-ons/gamemode_left4block/add-ins/player_l4b/models/face.ifl");
addExtraResource("add-ons/gamemode_left4block/add-ins/player_l4b/icons/DownCi.png");
addExtraResource("add-ons/gamemode_left4block/add-ins/player_l4b/icons/CI_VictimSaved.png");
addExtraResource("add-ons/gamemode_left4block/add-ins/player_l4b/icons/ci_boomer2.png");
addExtraResource("add-ons/gamemode_left4block/add-ins/player_l4b/icons/ci_charger2.png");
addExtraResource("add-ons/gamemode_left4block/add-ins/player_l4b/icons/ci_hunter2.png");
addExtraResource("add-ons/gamemode_left4block/add-ins/player_l4b/icons/ci_infected.png");
addExtraResource("add-ons/gamemode_left4block/add-ins/player_l4b/icons/ci_jockey2.png");
addExtraResource("add-ons/gamemode_left4block/add-ins/player_l4b/icons/ci_skull2.png");
addExtraResource("add-ons/gamemode_left4block/add-ins/player_l4b/icons/ci_smoker2.png");
addExtraResource("add-ons/gamemode_left4block/add-ins/player_l4b/icons/ci_witchclose.png");
addExtraResource("add-ons/gamemode_left4block/add-ins/player_l4b/icons/ci_spitter2.png");
