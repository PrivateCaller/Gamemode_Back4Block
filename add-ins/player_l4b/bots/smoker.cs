datablock fxDTSBrickData (BrickZombieSmoker_HoleSpawnData : BrickCommonZombie_HoleSpawnData)
{
	...
	iconName = "Add-Ons/Gamemode_Left4Block/add-ins/player_l4b/icons/icon_smoker";
...
datablock PlayerData(ZombieSmokerHoleBot : CommonZombieHoleBot)
{
	...
	hPinCI = "<bitmapk:Add-Ons/Gamemode_Left4Block/add-ins/player_l4b/icons/ci_smoker2>";
