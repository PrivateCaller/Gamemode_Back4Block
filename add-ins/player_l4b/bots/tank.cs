datablock fxDTSBrickData (BrickZombieTankBot_HoleSpawnData : BrickCommonZombie_HoleSpawnData)
{
	...
	iconName = "Add-Ons/Gamemode_Left4Block/add-ins/player_l4b/icons/icon_Tank";
...
datablock PlayerData(ZombieTankHoleBot : CommonZombieHoleBot)
{
	...
	shapeFile = "add-ons/gamemode_left4block/add-ins/player_l4b/models/tank/zTank.dts";
	...
	hPinCI = "<bitmapk:gamemode_left4block/add-ins/player_l4b/models/icons/ci_tank2>";
