datablock fxDTSBrickData (BrickZombieCharger_HoleSpawnData : BrickCommonZombie_HoleSpawnData)
{
	...
	iconName = "Add-Ons/Gamemode_Left4Block/add-ins/player_l4b/icons/icon_charger";
...
datablock PlayerData(ZombieChargerHoleBot : CommonZombieHoleBot)
{
	...
	resistMelee = true;
	hPinCI = "<bitmapk:Add-Ons/Gamemode_Left4Block/add-ins/player_l4b/icons/ci_charger2>";
...
function ZombieChargerHoleBot::hCustomNodeAppearance(%this,%obj)
{
	...
	if(%obj.getClassName() $= "Player")
	{
		...
		%obj.setnodeColor(LchargerArm,%obj.client.zombieColor);
	}
	else
	{
		%obj.setnodeColor(RarmCharger,%obj.rarmColor);
		%obj.setnodeColor(LchargerArm,%obj.larmColor);
	}
}
