...
AddDamageType("mudDirect",   '<bitmap:add-ons/gamemode_left4block/add-ins/player_l4b/icons/CI_snowball> %1',       '%2 <bitmap:add-ons/gamemode_left4block/add-ins/player_l4b/icons/CI_snowball> %1',1,1);
AddDamageType("mudRadius",   '<bitmap:add-ons/gamemode_left4block/add-ins/player_l4b/icons/CI_snowballRadius> %1', '%2 <bitmap:add-ons/gamemode_left4block/add-ins/player_l4b/icons/CI_snowballRadius> %1',1,0);

datablock ProjectileData(mud_Projectile)
{
	projectileShapeName = "add-ons/gamemode_left4block/add-ins/player_l4b/models/mud/mudball.dts";
	directDamage = 1;
...
{
	shapeFile  = "add-ons/gamemode_left4block/add-ins/player_l4b/models/mud/mudball.dts";
	emap = true;
	mountPoint = 0;
	offset = "0 0 0";
