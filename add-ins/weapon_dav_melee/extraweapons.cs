...
datablock ShapeBaseImageData(MacheteImage : crowbarImage){shapeFile = "add-ons/gamemode_left4block/add-ins/weapon_dav_melee/models/model_Machete.dts"; item = "MacheteItem"; doColorShift = MacheteItem.doColorShift; colorShiftColor = MacheteItem.colorShiftColor; meleeDamageDivisor = 1.275; meleeHitEnvSound = "Machete"; meleeHitPlSound = "Machete"; stateTimeoutValue[6] = 0.275;};
...
datablock ShapeBaseImageData(KatanaImage : crowbarImage){shapeFile = "add-ons/gamemode_left4block/add-ins/weapon_dav_melee/models/model_Katana.dts"; item = "KatanaItem"; doColorShift = KatanaItem.doColorShift; colorShiftColor = KatanaItem.colorShiftColor; meleeDamageDivisor = 1.275; meleeHitEnvSound = "Machete"; meleeHitPlSound = "Machete"; stateTimeoutValue[6] = 0.3;};
...
datablock ShapeBaseImageData(cKnifeImage : crowbarImage){shapeFile = "add-ons/gamemode_left4block/add-ins/weapon_dav_melee/models/model_cKnife.dts"; item = "cKnifeItem"; doColorShift = cKnifeItem.doColorShift; colorShiftColor = cKnifeItem.colorShiftColor; meleeDamageDivisor = 1.125; meleeHitEnvSound = "Machete"; meleeHitPlSound = "cKnife"; stateTimeoutValue[6] = 0.125;};
...
datablock ShapeBaseImageData(SpikebatImage : crowbarImage){shapeFile = "add-ons/gamemode_left4block/add-ins/weapon_dav_melee/models/model_Spikebat.dts"; item = "SpikebatItem"; doColorShift = SpikebatItem.doColorShift; colorShiftColor = SpikebatItem.colorShiftColor; meleeDamageDivisor = 1.25; meleeHitEnvSound = "Bat"; meleeHitPlSound = "Spikebat"; stateTimeoutValue[6] = 0.3;};
...
datablock ShapeBaseImageData(BatonImage : crowbarImage){shapeFile = "add-ons/gamemode_left4block/add-ins/weapon_dav_melee/models/model_Baton.dts"; item = "BatonItem"; doColorShift = BatonItem.doColorShift; colorShiftColor = BatonItem.colorShiftColor; meleeDamageDivisor = 1.25; meleeHitEnvSound = "Bat"; meleeHitPlSound = "Bat"; stateTimeoutValue[6] = 0.275;};
...
datablock ShapeBaseImageData(AxeImage : crowbarImage){shapeFile = "add-ons/gamemode_left4block/add-ins/weapon_dav_melee/models/model_Axe.dts"; item = "AxeItem"; doColorShift = AxeItem.doColorShift; colorShiftColor = AxeItem.colorShiftColor; meleeDamageDivisor = 1.15; meleeHitEnvSound = "Crowbar"; meleeHitPlSound = "Machete"; stateTimeoutValue[6] = 0.5;};
...
datablock ShapeBaseImageData(SledgehammerImage : crowbarImage){shapeFile = "add-ons/gamemode_left4block/add-ins/weapon_dav_melee/models/model_Sledgehammer.dts"; item = "SledgehammerItem"; doColorShift = SledgehammerItem.doColorShift; colorShiftColor = SledgehammerItem.colorShiftColor; meleeDamageDivisor = 1.25; meleeHitEnvSound = "Crowbar"; meleeHitPlSound = "Sledgehammer"; stateTimeoutValue[6] = 0.5;};
